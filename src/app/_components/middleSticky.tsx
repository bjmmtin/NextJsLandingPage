    ...
    return (
        <div className="flex justify-between lg:px-64 py-6 text-white bg-[#52105b]">
            ...
            <div className="text-xl ">
                Excellent
                <div className="relative pt-5 w-[100%] inline-block "  >
                    <svg role="img" viewBox="0 0 251 46" xmlns="http://www.w3.org/2000/svg" className="absolute h-[100%] w-[100%] left-0 top-0" >
                        <g className="tp-star">
                ...
                <div className="text-white inline-block">
                    <div className="relative h-0 w-[100%] p-0 pb-[24%] pl-6 text-sm" >
                        <svg role="img" viewBox="0 0 126 31" xmlns="http://www.w3.org/2000/svg" className="absolute h-[100%] w-[100%] left-0 top-0" >
