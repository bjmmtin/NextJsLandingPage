...
export function Footer() {
  ...
  return (
    <div>
      ...
      <div className=" bg-[#52105b] text-white ">
        <div className="2xl:mx-60 py-8 flex border-b border-[rgba(38,38,38,75)]">
            ...
            <div className="w-[calc(19%-0.75rem)]">
              ...
              <div className="text-xl ">
                <div className="text-white pt-2">
                  <div className="relative h-0 w-[100%] pb-7  pl-5 text-sm" >
                    <svg role="img" viewBox="0 0 126 31" xmlns="http://www.w3.org/2000/svg" className="absolute h-[20px] left-0 top-0" >
                ...
                <svg role="img" viewBox="0 0 251 46" xmlns="http://www.w3.org/2000/svg" className="h-[26px]" >
                  <g className="tp-star">
                ...
                <div className="text-[12px]">TrustScore 4.52,291 reviews</div>
      ...
      <div className="bg-[#52105b] pb-40 pt-8">
        <div className="2xl:mx-60 flex">
          <div className="text-white px-3">
            <a className="" href="/">
              <svg xmlns="http://www.w3.org/2000/svg" className="h-[29px]" enable-background="new 0 0 489.4 64.2" viewBox="0 0 489.4 64.2"><path d="M27.4 54.8" fill="#fff"></path><g>
